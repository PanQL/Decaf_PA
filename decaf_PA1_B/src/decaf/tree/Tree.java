...
public abstract class Tree {
    ...
    public static final int MOMO = SEALEDCLASSDEF + 1;
    public static final int PLUSPLUS = MOMO + 1;
    public static final int DEFAULT = PLUSPLUS + 1;
    ...
    public static class GuardedStmt extends Tree {
    	...
    	public GuardedStmt(List<Expr> branches, Expr expr, Location loc) {
            super(IFBRANCHES,loc);
            this.branches = new ArrayList<Expr>();
            if(expr != null)
                this.branches.add(expr);
    ...
    public static abstract class Visitor {
        ...
        public void visitIfSubStmt(Tree that) {
        	visitTree(that);
        }
        
        public void visitIfBranches(Tree that) {
        	visitTree(that);
        }

        public void visitVarIdent(Tree that) {
        	visitTree(that);
        }
