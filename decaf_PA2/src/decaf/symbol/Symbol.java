...
public abstract class Symbol {
	protected String name;	//符号表项的名字

	protected Scope definedIn;	//定义这一符号的表

	protected Type type;	//符号的类型

	protected int order;	//还不知道是做什么的

	protected Location location;	//符号所在的位置
