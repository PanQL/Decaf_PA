...
public abstract class Tree {
    ...
    public static final int IFBRANCHES = IFSUBSTMT + 1;
    public static final int ARRAYCONST = IFBRANCHES + 1;
    public static final int ARRAYREPEAT = ARRAYCONST + 1;
    public static final int ARRAYRANGE = ARRAYREPEAT + 1;
    public static final int ARRAYDEFAULT = ARRAYRANGE + 1;
    public static final int ARRAYCOMP = ARRAYDEFAULT + 1;
    public static final int FOREACHSTMT = ARRAYCOMP + 1;
    public static final int SEALEDCLASSDEF = FOREACHSTMT + 1;
    ...
    public static class TypeVar extends TypeLiteral {
        ...
        public boolean typeDefined = false;
    ...
    public static class ScopyClass extends Tree {
        ...
        public Ident ident;
        public Expr expr;
        public Location loc,idloc;
    	
    	public ScopyClass(String ident, Expr expr,Location loc,Location idloc) {
            super(SCOPY, loc);
            this.ident = new Ident(null, ident, idloc);
    ...
    public static class BoundVariable extends VarDef{
    ...
    public static class ForeachBlock extends Block{
        public ForeachBlock(List<Tree> tlist, Location location){
            super(tlist, location);
        }

        @Override
        public void accept(Visitor v) {
            v.visitForeachBlock(this);
        }
    }
    ...
    public static class ForeachStmt extends Tree{
        ...
        public ForeachStmt(VarDef boundVariable,Expr arr, 
            Expr judge, List<Tree> treeList, Location tlistloc, Location loc) {
            super(FOREACHSTMT,loc);
            this.boundVariable = boundVariable;
    		this.arr = arr;
    		this.judge = judge;
    		this.block = new ForeachBlock(treeList,tlistloc);
    		this.loc = loc;
    	}
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		// pw.incIndent();
    		// if(type == null)
    		// 	pw.println("varbind " + boundVariable.name + " var");
    		// else {
    		// 	pw.print("varbind " + boundVariable.name + " ");
    		// 	type.printTo(pw);
    		// 	pw.println();
    		// }
    		// arr.printTo(pw);
